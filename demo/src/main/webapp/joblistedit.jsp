...
<li class="active"><a href="homenew.jsp">HOME </a></li>
...
<div class=" nav navbar-nav dropdown">
  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="joblistcreate.jsp">CREATE</a></li>
  </ul></font>
</div>
...
<font size="6" color="orange" style="font-family:comic sans ms" >EDIT JOB LIST </font>
<br><br>
<table border=5 height=50% bordercolor=white  width=90%>
<tr>
<th><font size="5">JOB ID</th>
<th><font size="5">JOB DESCRIPTION</th>
<th><font size="5">JOB NAME</th>
<th><font size="5">ACTIONS</th>
</tr>
<tr>
<td> </td>
<td> </td>
